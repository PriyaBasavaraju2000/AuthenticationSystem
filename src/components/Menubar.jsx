    ...
    const sendVerificationOtp = async () => {
        try {
            ...
            if (response.status === 200) {
                ...
                toast.error("Unable to send OTP verification code!");
            }
        } catch (error) {
        ...
        return (
            <nav className="navbar bg-white px-5 py-4 d-flex justify-content-center-between align-items-center">
                <div className="d-flex align-items-center gap-2">
                    <img src={assets.logo} alt="logo" width={32} height={32}/>
                    <span className="fw-bold fs-4 text-dark">Authen Forge</span>
                </div>
                        ...
                        {dropdownOpen && (
                            <div className="position absolute shadow bg-white rounded p-2"
                                ...
                                {!userData.isAccountVerified && (
                                    <div className="dropdowm-item py-1 px-2" style={{cursor: "pointer"}}
